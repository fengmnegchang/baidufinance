 ...
 ***************************************************************************************************************************************************************************** 
 */
public class MFootTagNewsPullListFragment extends CommonPullToRefreshListFragment<TagNewsBean, TagNewsDataJson> implements ScrollableContainer {
	private TagNewsAdapter mTagNewsAdapter;
	
	public static MFootTagNewsPullListFragment newInstance(String url, boolean isVisibleToUser) {
		MFootTagNewsPullListFragment fragment = new MFootTagNewsPullListFragment();
	...
	public void volleyJson(final String href) {
		...
		}, MFootTagNewsPullListFragment.this);
