 ...
 *****************************************************************************************************************************************************************************
 */
public class MFootTagNewsIndicatorFragment extends TagNewsIndicatorFragment {
	public static MFootTagNewsIndicatorFragment newInstance(String url, boolean isVisibleToUser) {
		MFootTagNewsIndicatorFragment fragment = new MFootTagNewsIndicatorFragment();
