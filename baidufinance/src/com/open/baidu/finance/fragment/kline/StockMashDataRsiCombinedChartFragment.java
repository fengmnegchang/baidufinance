 ...
 ***************************************************************************************************************************************************************************** 
 */
public class StockMashDataRsiCombinedChartFragment extends BaseV4Fragment<MashDataJson, StockMashDataRsiCombinedChartFragment> {
	...
	public static StockMashDataRsiCombinedChartFragment newInstance(String url, boolean isVisibleToUser) {
		StockMashDataRsiCombinedChartFragment fragment = new StockMashDataRsiCombinedChartFragment();
	...
	public void initValues() {
		...
		super.initValues();
		combinedchart.setDescription("");//.setEnabled(false);
...
//                
					...
					txt_price.setText("价 " + String.format("%.2f", list.get((int) e.getXIndex()).getKline().getClose()));
...
//				txt_volume.setText("量 " + String.format("%.2f", list.get((int) e.getX()).getKline().getVolume() / 100f / 10000f) + "万手");
	...
	public void volleyJson(final String href) {
		...
		}, StockMashDataRsiCombinedChartFragment.this);
