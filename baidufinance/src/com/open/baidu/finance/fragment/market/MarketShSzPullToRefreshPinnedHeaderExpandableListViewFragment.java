 ...
 *****************************************************************************************************************************************************************************
 */
public class MarketShSzPullToRefreshPinnedHeaderExpandableListViewFragment extends BaseV4Fragment<MarketShSzJson, MarketShSzPullToRefreshPinnedHeaderExpandableListViewFragment>
implements OnRefreshListener<ExpandableListView>
{
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		mPullToRefreshExpandableListView = (PullToRefreshExpandableListView) view.findViewById(R.id.pull_refresh_list);
		return view;
	}
	...
	public void handlerMessage(Message msg) {
		...
		case MESSAGE_HANDLER:
			list.clear();
			plate(UrlUtils.NEWSINAHY,1,"新浪行业涨幅榜");
			plate(UrlUtils.SWHY,2,"申万涨幅榜");
			plate(UrlUtils.NEWFLJK_CLASS,3,"概念涨幅榜");
			plate(UrlUtils.NEWFLJK_AREA,4,"地域涨幅榜");
			plate(UrlUtils.NEWFLJK_INDUSTRY,5,"行业涨幅榜");
			stock(UrlUtils.GETHQNODEDATA_CHANGE_PERCENT_0,6,"涨幅榜");
			stock(UrlUtils.GETHQNODEDATA_CHANGE_PERCENT_1,7,"跌幅榜");
			stock(UrlUtils.GETHQNODEDATA_NEW_STOCK,8,"次新股涨幅榜");
			stock(UrlUtils.STOCK_HS_UP_5MIN_20,9,"涨速榜");
			stock(UrlUtils.GETHQNODEDATA_TURNOVERRATIO,10,"换手率榜");
			stock(UrlUtils.GETHQNODEDATA_AMOOUNT,11,"成交额");
			break;
		}
	}
...
//				System.out.println("response=" + response.toString());
				...
				try {
					...
					mmbean.getSlist().clear();
					mmbean.setSlist(slist);
					mmbean.setGroupName(groupName);
					mmbean.setGroupType(type);
